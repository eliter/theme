        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="/app/invoice/preview/" class="btn btn-sm btn-icon btn-text-secondary rounded-pill text-body" data-bs-toggle="tooltip" title="Preview"><i class="mdi mdi-eye-outline mdi-24px mx-1"></i></a>' +
